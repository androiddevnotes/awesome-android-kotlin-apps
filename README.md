...
- https://github.com/xiaoyanger0825/wanandroid
  ...
  - Kotlin+JetPack+协程实现的 MVVM 架构 Wanandroid 客户端
...
- https://github.com/idisfkj/AwesomeGithub
  ...
  - Android Github 客户端，基于组件化开发，支持账户密码与认证登陆。使用 Kotlin 语言进行开发，项目架构是基于 JetPack&DataBinding 的 MVVM；同时支持组件开发，使用 Arouter 进行组件间的跳转；网络框架使用了 Retrofit&Coroutine。项目持续更新中，为了防止走失，请做好 start 准备！😊😊
